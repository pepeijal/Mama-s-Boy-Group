...
public class Navigation {
    public static void main(String[] args) {
        ...
        try{
            ...
            Scanner read = new Scanner(new FileInputStream ("C:\\Users\\Ideapad 3\\Downloads\\DS-Assignment-2022-main\\DS-Assignment-2022-main\\tasks\\navigation\\cases\\1.txt")); // read text file
